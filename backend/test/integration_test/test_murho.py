...
@pytest.mark.parametrize("beams_springfield, beams_springfield_excel", [
    (beams_springfield, beams_springfield_excel)
])
...
test_hogwarts(beams_hogwarts, beams_hogwarts_excel)
test_springfield(beams_springfield, beams_springfield_excel)
