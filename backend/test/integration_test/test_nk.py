...
CHAMBER_SN_FARMER = ["nk_3587", "nk_5447", "nk_5448"]
CHAMBER_SN_PP = ["nk_1508", "nk_858"]
...
@pytest.mark.parametrize("beam, chambers, expected_1, expected_2", [
	({
		 ...
		 "hvl_measured_cu": 0,
	 }, CHAMBER_SN_FARMER, {'nk_3587': 49.8986656857429,
...
def test_nk0(beam, chambers, expected_1, expected_2):
	first, second, warn = select_from_farmer(cursor,
											 beam["kvp"],
...
@pytest.mark.parametrize("beam, chambers, expected_1, expected_2", [
	...
	}, CHAMBER_SN_FARMER, {'nk_3587': 47.9552891833685,
...
@pytest.mark.parametrize("beam, chambers, expected_1, expected_2", [
	({
		...
		"hvl_measured_cu": 0,
	}, CHAMBER_SN_FARMER, {'nk_3587': 47.7093008745159,
...
@pytest.mark.parametrize("beam, chambers, expected_1, expected_2", [
	({
		...
		"hvl_measured_cu": 0,
	}, CHAMBER_SN_FARMER, {'nk_3587': 47.8983043309663,
...
@pytest.mark.parametrize("beam, chambers, expected_1, expected_2", [
	...
	}, CHAMBER_SN_FARMER, {'nk_3587': 47.8056873399266,
...
@pytest.mark.parametrize("beam, chambers, expected_1, expected_2", [
	({
		...
		"hvl_measured_al": 0,
		"hvl_measured_cu": 1.4,
	}, CHAMBER_SN_FARMER, {'nk_3587': 48.0752383270639,
