...
REF_BEAMS = [
    {"beam_farmer_id": "NXJ60", "kvp": 60, "hvl_measured_cu": None,
     "hvl_measured_al": 0.788813791651093, "nk_3587": 49.8986656857429,
     "nk_5447": 50.7, "nk_5448": 51.5},
    {"beam_farmer_id": "NXK60", "kvp": 60, "hvl_measured_cu": None,
     "hvl_measured_al": 1.28860110150315, "nk_3587": 48.3988130247751,
     "nk_5447": 49.3, "nk_5448": 50.1}
]

REF_BEAMS2=[
    {"beam_farmer_id": "NXB120", "kvp": 120, "hvl_measured_cu": 0.229716813754473,
     "hvl_measured_al": 5.55599697591481, "nk_3587": 47.7093008745159,
     "nk_5447": 47.8597516857949, "nk_5448": 48.5210001193312},
    {"beam_farmer_id": "NXC120", "kvp": 120, "hvl_measured_cu": 0.280623113903494,
     "hvl_measured_al": 6.37697784783916, "nk_3587": 47.7411047431016,
     "nk_5447": 47.8406595597577, "nk_5448": 48.4969968164535}
]

REF_BEAMS3 = [
    {"beam_farmer_id": "NXE250", "kvp": 250, "hvl_measured_cu": 1.61280416689842,
     "hvl_measured_al": None, "nk_3587": 48.0926889791271,
     "nk_5447": 47.8694372925679, "nk_5448": 48.1739224296041},
    {"beam_farmer_id": "NXF250", "kvp": 250, "hvl_measured_cu": 2.13567218440762,
     "hvl_measured_al": None, "nk_3587": 48.115151223515,
     "nk_5447": 47.9021260939212, "nk_5448": 48.1429169731479}
]

REF_BEAMS4 =[
    {"beam_plainparallel_id": "RT5", "kvp": 55, "hvl_measured_al": 0.8060,
     "nk_1508": 1033.92690609361, "nk_858": 82.0878589140421},
    {"beam_plainparallel_id": "RT6", "kvp": 70, "hvl_measured_al": 1.3040,
     "nk_1508": 1025.75342949661, "nk_858": 81.7610639245557}
]
...
def test_interpo1():
    ans = interpolation(REF_BEAMS[0]["nk_3587"],
                        REF_BEAMS[1]["nk_3587"],
...
def test_interpo2():
    ans = interpolation(REF_BEAMS2[0]["nk_5447"],
...
def test_interpo3():
    ans = interpolation(REF_BEAMS3[0]["nk_3587"],
...
def test_interpo5():
    ans_al = interpolation(REF_BEAMS2[0]["nk_5447"],
                           REF_BEAMS2[1]["nk_5447"],
                           REF_BEAMS2[0]["hvl_measured_al"],
                           REF_BEAMS2[1]["hvl_measured_al"],
                           BEAMS[3]["hvl_measured_al"])
    ans_cu = interpolation(REF_BEAMS2[0]["nk_5447"],
                           REF_BEAMS2[1]["nk_5447"],
                           REF_BEAMS2[0]["hvl_measured_cu"],
                           REF_BEAMS2[1]["hvl_measured_cu"],
                           BEAMS[3]["hvl_measured_cu"])
...
def test_interpo6():
    ans = interpolation(REF_BEAMS4[0]["nk_1508"],
